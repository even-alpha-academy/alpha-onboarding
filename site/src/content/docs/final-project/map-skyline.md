...
אם ההקמה נלחמת בכם יותר מיום, **המנטור מוסר לכם את קטע האתחול העובד** ואתם ממשיכים ל-wrapper. לוח הזמנים חשוב יותר מהסבל. (זה מתואר גם ב[מחווני המנטור](/alpha-onboarding/mentor/rubrics/).)
