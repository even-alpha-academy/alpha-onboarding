...
- **Plan mode** — Navigator עם חגורת בטיחות: הכלי מציע תוכנית שאתם מאשרים לפני כל עריכה. זו ברירת המחדל המומלצת לנחפפים במהלך פרויקט הגמר.
- **Permission prompts** — נקודת הביקורת: אל תאשרו אוטומטית שום דבר שלא הייתם מאשרים ב-MR.
- **Slash commands / skills** — קיימים (למשל code review). דעו שהם שם, והפנו לתיעוד; אין צורך ללמוד את כולם עכשיו.

## דפוסי עבודה מומלצים לנחפף
